...
{
   dec string[] feature = "1.test_simple_priority_int : ";
...
{
   dec string[] feature = "2.test_complex_priority_int : ";
   call print(ref feature);
   dec int32 a = 2;
   dec int32 b = 3;
   dec int32 c = 4;
...
{
   dec string[] feature = "3.test_state_update_int : ";
   call print(ref feature);
   dec int32 a = 1;
   dec int32 b = 5;
...
{  
   dec string[] feature = "4.test_pass_arg_function : ";
   call print(ref feature);
   if ((a == 10) && (b == 25.5)) {
      return true;
   } else {
...
{
   dec string[] feature = "5.test_depth_equation : ";
   call print(ref feature);
...
{
   dec string[] feature = "6.test_assignment : ";
   call print(ref feature);
   dec int32 a = 5;
   aff a = 10; 
   if (a == 10) {
...
{
   dec string[] feature = "7.test_auto_increment : ";
   call print(ref feature);
   dec int32 a = 10;
...
{
      dec string[] feature = "8.test_variable_copy_int : ";
      call print(ref feature);
   dec int32 a = 50;
...
{
      dec string[] feature = "9.test_nesting_int : ";
      call print(ref feature);
   dec int32 a = 1;
   dec int32 b = 2;
