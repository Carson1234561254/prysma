...
{
   dec string[] feature = "1.test_new_delete_float_basic : ";
...
{
   dec string[] feature = "2.test_new_delete_float_zero : ";
   call print(ref feature);
   dec ptr p = new float;
   aff p = 0.0;
   dec float value = unref p;
...
{
   dec string[] feature = "3.test_new_delete_float_negative : ";
   call print(ref feature);
   dec ptr p = new float;
...
{
   dec string[] feature = "4.test_new_delete_float_small_value : ";
   call print(ref feature);
   dec ptr p = new float;
   aff p = 0.001;
   dec float value = unref p;
...
{
   dec string[] feature = "5.test_new_delete_float_reassignment : ";
   call print(ref feature);
   dec ptr p = new float;
   aff p = 1.1;
   aff p = 55.5;
