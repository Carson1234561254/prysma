...
{
   dec string[] feature = "1.test_pass_ptr_int32_by_argument : ";
...
{
   dec string[] feature = "2.test_pass_ptr_value_zero_by_argument : ";
   call print(ref feature);
   dec ptr p = new int32;
   aff p = 0;
...
{
   dec string[] feature = "3.test_pass_ptr_bool_by_argument : ";
   call print(ref feature);
   dec ptr p = new bool;
   aff p = true;
...
{
   dec string[] feature = "4.test_pass_two_ptr_by_argument : ";
   call print(ref feature);
...
{
   dec string[] feature = "5.test_pass_ptr_to_two_functions : ";
   call print(ref feature);
   dec ptr p = new int32;
   aff p = 999;
