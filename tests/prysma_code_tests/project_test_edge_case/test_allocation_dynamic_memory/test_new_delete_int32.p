...
{
   dec string[] feature = "1.test_new_delete_int32_basic : ";
...
{
   dec string[] feature = "2.test_new_delete_int32_zero : ";
   call print(ref feature);
   dec ptr p = new int32;
   aff p = 0;
   dec int32 value = unref p;
...
{
   dec string[] feature = "3.test_new_delete_int32_negative : ";
   call print(ref feature);
   dec ptr p = new int32;
...
{
   dec string[] feature = "4.test_new_delete_int32_large_value : ";
   call print(ref feature);
   dec ptr p = new int32;
   aff p = 2147483;
   dec int32 value = unref p;
...
{
   dec string[] feature = "5.test_new_delete_int32_reassignment : ";
   call print(ref feature);
   dec ptr p = new int32;
   aff p = 10;
   aff p = 99;
