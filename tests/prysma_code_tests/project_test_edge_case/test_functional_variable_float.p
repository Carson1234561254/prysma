...
{
   dec string[] feature = "1.test_simple_precedence : ";
...
{
   dec string[] feature = "2.test_complex_precedence : ";
   call print(ref feature);
   dec float a = 2.0;
   dec float b = 3.0;
   dec float c = 4.0;
...
{
   dec string[] feature = "3.test_state_update : ";
   call print(ref feature);
   dec float a = 1.0;
   dec float b = 5.0;
...
{
   dec string[] feature = "8.test_copy_variable : ";
   call print(ref feature);
   dec float a = 50.0;
...
{
   dec string[] feature = "9.test_nesting : ";
   call print(ref feature);
   dec float a = 1.0;
   dec float b = 2.0;
