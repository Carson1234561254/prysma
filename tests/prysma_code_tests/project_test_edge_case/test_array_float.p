...
{
    dec string[] feature = "1.array_test_reading : ";
...
{
    dec string[] feature = "2.array_test_assignment : ";
    call print(ref feature);
    dec float[4] array = [0.0, 1.0, 2.0, 3.0];
...
{
    dec string[] feature = "3.array_test_out_of_bounds : ";
    call print(ref feature);
    dec float[4] array = [0.0, 1.0, 2.0, 3.0];
...
{
    dec string[] feature = "4.array_variable_test : ";
    call print(ref feature);
    dec float a = 4.0; 
    dec float b = 2.0; 
...
{
    dec string[] feature = "5.array_test_dynamic_index : ";
    call print(ref feature);
...
{
    dec string[] feature = "6.array_test_stack_integrity : ";
    call print(ref feature);
    dec float a = 100.0;
...
{
    dec string[] feature = "7.array_test_iteration : ";
    call print(ref feature);
...
{
    dec string[] feature = "8.array_test_return : ";
    call print(ref feature);
    dec float[4] array = [0.0, 1.0, 2.0, 3.0];
    return array;
}
...
{
    dec string[] feature = "9.array_test_return_reading : ";
    call print(ref feature);
...
{
    dec string[] feature = "10.array_injection_argument : ";
    call print(ref feature);
    if (array[0] != 0.0) {
        return false;
    }
...
{
    dec string[] feature = "11.array_test_argument : ";
    call print(ref feature);
