...
std::shared_ptr<INoeud> StrategieUnRef::construire(std::vector<Token>& equation, [[maybe_unused]] IConstructeurArbre* constructeurEquation, [[maybe_unused]] IConstructeurArbre* instructionBuilder) {
