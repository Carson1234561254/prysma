...
void VisiteurGeneralGenCode::visiter(NoeudWhile* noeudWhile) 
{
    ...
    std::shared_ptr<INoeud> noeudCondition = noeudWhile->noeudCondition;
    std::shared_ptr<INoeud> noeudBlocWhile = noeudWhile->noeudBlocWhile;
    std::shared_ptr<INoeud> noeudBlocEndWhile = noeudWhile->noeudBlocFinWhile;
