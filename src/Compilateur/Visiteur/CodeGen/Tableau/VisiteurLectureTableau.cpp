...
void VisiteurGeneralGenCode::visiter(NoeudLectureTableau* noeudLectureTableau)
{
    ...
    llvm::Value* adresseTableau = _contextGenCode->registreVariable->recupererVariables(noeudLectureTableau->getNomTableau());
    ...
    llvm::Value* adresseElement = _contextGenCode->backend->getBuilder().CreateGEP(typeTableau, adresseTableau, 
        { 
            ...
            _contextGenCode->valeurTemporaire 
    ...
    _contextGenCode->valeurTemporaire = valeurElement;
} 
