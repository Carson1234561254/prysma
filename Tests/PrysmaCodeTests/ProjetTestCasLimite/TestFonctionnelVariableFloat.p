...
fn bool testPrioriteComplexe_float()
{
...
fn bool testPassArgFonction_float(arg float a, arg float b)
{  
...
fn bool testProfondeurEquation_float()
{
...
fn int32 testFonctionnelVariableFloat()
{
   call print(call testPrioriteSimple_float()); call backSlashN();
   call print(call testPrioriteComplexe_float()); call backSlashN();
   call print(call testMiseAJourEtat_float()); call backSlashN();

   // false test : je dois corriger ça plus tard
   dec float a = 10.0; 
   dec float b = 25.5;
   call print(call testPassArgFonction_float(a,b)); call backSlashN();
   
   // Appeler la méthode de nouveau pour voir si le contexte n'a pas changé
   dec float d = 10.0; 
   dec float e = 25.5;
   call print(call testPassArgFonction_float(d,e)); call backSlashN();
   call print(call testProfondeurEquation_float()); call backSlashN();

   call print(call testAffectation_float()); call backSlashN();
