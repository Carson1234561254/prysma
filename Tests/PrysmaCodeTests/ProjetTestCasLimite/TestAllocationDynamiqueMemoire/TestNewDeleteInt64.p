...
{
   dec string[] fonctionnalite = "1.testNewDeleteInt64Basique : ";
...
{
   dec string[] fonctionnalite = "2.testNewDeleteInt64Zero : ";
   call print(ref fonctionnalite);
   dec ptr p = new int64;
   aff p = 0;
   dec int32 val = unref p;
...
{
   dec string[] fonctionnalite = "3.testNewDeleteInt64Negatif : ";
   call print(ref fonctionnalite);
   dec ptr p = new int64;
...
{
   dec string[] fonctionnalite = "4.testNewDeleteInt64GrandeValeur : ";
   call print(ref fonctionnalite);
   dec ptr p = new int64;
   aff p = 9999999;
   dec int32 val = unref p;
...
fn bool testNewDeleteInt64Reaffectation()
{
   dec string[] fonctionnalite = "5.testNewDeleteInt64Reaffectation : ";
   call print(ref fonctionnalite);
   dec ptr p = new int64;
   aff p = 1;
   aff p = 777;
...
fn int32 testNewDeleteInt64()
{
   ...
   call print(call testNewDeleteInt64Reaffectation()); call backSlashN();
